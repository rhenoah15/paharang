...
@keyframes fade {
  ...
  to {opacity: 1}
	...
	<!-- start -->			
<h2>Registration List - Junior HighSchool 
<br>	
</h2>
...
<br>
	...
	<div style="width:100%;overflow-x:scroll">
		<table id="customers" class="tftable order-table table bluetext">
			...
			<?php
				include('../connect.php');
				$result = mysql_query("SELECT * FROM juniorstudents WHERE status = 'Pending' ");
				while($row = mysql_fetch_array($result))
					{
						...
						echo '<td width="25%"><div align="center"><a  href="approve_student.php?id='.$row['idnumber'].'&email='.$row['email'].'">Approve</a> 
						| <a href="decline_student.php?id='.$row['idnumber'].'" id="'.$row['idnumber'].'" class="delbutton" title="Click To Drop">Decline</a></a>   
						</div></td>';
						echo '</tr>';
					}
				?> 
