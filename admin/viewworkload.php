...
<form name="form1" method="post" action="schedvalidate.php"  onsubmit="return checksched()">
...
<tbody align="left" style="font-family:Arial;font-size:13;">
  ...
  <tr>
    ...
    <td width="85%">
      <label>
       <select name="teacher" id="teacher"  onChange="showUser(this.value)"  style="width:100%">
	   <option></option>
		<?php
		include('../connect.php');
		$id=$_GET['id'];
  ...
  <tr>
    <td>Subject:</td>
    <td><label>
        <select name="subject" id="subject"  onChange="subj(this.value)" style="width:100%">
	 	</select>
    </label></td>
  ...
  <tr>
    <td>Room:</td>
    <td><label>
	<input type="text" name="room" class="ed" id="room" >
  ...
  <tr>
    <td>Day1:</td>
    <td><select name="days1" id="days1"   onChange="day1(this.value)"> 
      <option></option>
  ...
  <tr>
	...
	<select name="timein" id="timein" onChange="checkday1(this.value)"> 
      <option></option>
	  <option>07:00 AM</option>
	  <option>08:00 AM</option>
	  <option>09:00 AM</option>
	  <option>10:00 AM</option>
	  <option>101:00 AM</option>
...
<td>Day2:</td>
	...
	<select name="days2" id="days2" onChange="day2(this.value)"> 
      <option></option>
	  <option>Monday</option>
      <option>Tuesday</option>
      <option>Wednesday</option>
  ...
  <tr>
    <td>Time Start:</td>
    <td><label>.
	<select  name="timein2" id="timein2"  onChange="checkday2(this.value)">
      <option></option>
	  <option>07:00 AM</option>
	  <option>08:00 AM</option>
	  <option>09:00 AM</option>
...
<option></option>
  ...
  <tr>
	...
	<select name="timein3" id="timein3"  onChange="checkday3(this.value)">
      <option></option>
	  <option>07:00 AM</option>
	  <option>08:00 AM</option>
	  <option>09:00 AM</option>
  ...
  <tr>
    <td>Time Finish:</td>
    <td><label>
	<select name="timeout3" id="timeout3"> 
      <option></option>
	  <option>08:00 AM</option>
	  <option>09:00 AM</option>
	  <option>10:00 AM</option>
...
<td>Day4:</td>
  ...
  <tr>
	...
	<select name="timein4" id="timein4"  onChange="checkday4(this.value)">
      <option></option>
	  <option>07:00 AM</option>
	  <option>08:00 AM</option>
	  <option>09:00 AM</option>
  ...
  <tr>
    <td>Time Finish:</td>
    <td><label>
	<select name="timeout4" id="timeout4" > 
      <option></option>
	  <option>08:00 AM</option>
	  <option>09:00 AM</option>
	  <option>10:00 AM</option>
...
<td>Day5:</td>
  ...
  <tr>
    <td>Time Start:</td>
    <td><label>
	<select name="timein5" id="timein5"   onChange="checkday5(this.value)">
      <option></option>
	  <option>07:00 AM</option>
	  <option>08:00 AM</option>
	  <option>09:00 AM</option>
  ...
  <tr>
    <td>Time Finish:</td>
    <td><label>
	<select name="timeout5" id="timeout5"> 
      <option></option>
	  <option>08:00 AM</option>
	  <option>09:00 AM</option>
	  <option>10:00 AM</option>
...
<input type="submit" name="submit" id="submit" value="Submit" style="background:#004BAA">
	  
</form>
<input type="button" value="Set Schedule as Done" style="float:right;background:#004BAA" onclick="window.location='done12.php?id=<?php echo $_GET['id'] ?>'" style="background:#004BAA">
  ...
  <script>
	function checkday1(value) {
		...
		$.ajax({
                    ...
                    data:{
                        time:value,
                        day:document.getElementById('days1').value,
				   ...
				   console.log(data);
					  ...
					  if(data>0) {
						  alert("Sorry the time, day and room you are trying to add schedule is already taken.");
					  }
                   },
				   error : function(err) {
