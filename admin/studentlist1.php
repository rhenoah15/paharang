...
@keyframes fade {
  ...
  to {opacity: 1}
	...
	<!-- start -->			
<h2>Student List - Junior HighSchool
<br>
<?php echo $_GET['id'] ?>
</h2>
...
<a href="addstud1.php?course=<?php echo $_GET['course'] ?>&section=<?php echo $_GET['id'] ?>" class="btn" rel="facebox" style="float:right;width:200px">Enroll Student</a>
<a href="subject1a.php?course=<?php echo $_GET['course'] ?>" class="btn"  style="float:right;width:200px;padding:10px;">View Prospectus</a>
<br>
	<div style="width:100%;overflow-x:scroll">
		<table id="customers" class="tftable order-table table bluetext">
			...
			<?php
				...
				$section=$_GET['id'];
				$course = $_GET['course'];
				$result = mysql_query("SELECT * FROM juniorstudents WHERE course = '$course' AND section = '$section' AND status1 <> 'Drop' AND status <> 'Pending'");
				while($row = mysql_fetch_array($result))
					{
						...
						echo '<td width="25%"><div align="center"><a rel="facebox" href="viewsubject1.php?id='.$row['idnumber'].'&course='.$row['course'].'">View Load</a> 
						| <a href="drop1a.php?id='.$row['id'].'" id="'.$row['idnumber'].'" class="delbutton" title="Click To Drop">Drop</a> | 
						<a rel="facebox" href="changeyear1.php?id='.$row['idnumber'].'" >Change Year</a>   
						</div></td>';
						echo '</tr>';
					}
				?> 
