...
@keyframes fade {
  ...
  to {opacity: 1}
	...
	<!-- start -->			
<h2>Registration List - Senior HighSchool 
<br>	
</h2>
...
<br>
	...
	<div style="width:100%;overflow-x:scroll">
		<table id="customers" class="tftable order-table table bluetext">
			...
			<?php
				include('../connect.php');
				$result = mysql_query("SELECT * FROM seniorstudents WHERE status = 'Pending' ");
				while($row = mysql_fetch_array($result))
					{
						...
						echo '<td><div align="left">'.$row['grade'].'</div></td>';
						...
						echo '<td width="25%"><div align="center"><a  href="approve_student1.php?id='.$row['idnumber'].'&email='.$row['email'].'"><i class="fa-solid fa-thumbs-up"></i></a> 
						| <a href="decline_student1.php?id='.$row['idnumber'].'" id="'.$row['idnumber'].'" class="delbutton" title="Click To Drop"><i class="fa-duotone fa-user-minus"></i></a></a>   
						</div></td>';
						echo '</tr>';
					}
				?> 
