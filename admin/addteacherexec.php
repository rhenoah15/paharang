...
if($count>0) {
echo '<script>alert("The ID you are trying to register is already on the database. Press OK to continue");window.history.back();</script>';	
} else {
...
$to      = $_POST['email'];
    ...
    $message = 'Good day! This is Paharang Integrated School.. We are glad to inform you that you are now registered as faculty at Paharang Integrated School. with your ID '.$idnumber.' as your username and "password" without quotes as your password. Thank you. Please do not reply. This is system generated email';
...
mysql_query("INSERT INTO teacher (fname, lname, mname, idnumber, work, gender, status, bday,type,email,image,d1,d2)
VALUES ('$fname','$lname','$mname','$idnum','$work','$gender','$status','$bday','$type','$email','$image','$grade','$strand')");
