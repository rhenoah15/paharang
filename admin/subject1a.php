...
@keyframes fade {
  ...
  to {opacity: 1}
	...
	<!-- start -->			
<h2>Prospectus - Junior High School
<br>
...
if(isset($_POST['submit'])) {
	...
	$course = $_GET['course'];
mysql_query("INSERT INTO juniorsubjects (subject, description,course)
VALUES ('$subject','$description','$course')");
...
<input name="description" type="text"  class="form"id="brnu" required />
<br>
...
<h3>Subject List</h3>
       ...
       <thead>
			...
			<?php
				include('../connect.php');
				$course = $_GET['course'];
				$result = mysql_query("SELECT * FROM juniorsubjects WHERE  course = '$course'  ORDER BY subject ASC");
				while($row = mysql_fetch_array($result))
					{
						...
						echo '<td><div align="center"><a href="subject1a.php?id='.$row['id'].'&course='.$course.'" id="'.$row['id'].'" class="delbutton" title="Click To Delete" onclick="return confirm(\'Are you sure you want to delete this record?\')">Delete</a></div></td>';
						echo '</tr>';
					}
				?> 
			</tbody>
