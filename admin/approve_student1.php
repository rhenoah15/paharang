...
include('../connect.php');
$id =$_GET['id'];
mysql_query("UPDATE login SET status = 'student' WHERe username = '$id'");
mysql_query("UPDATE seniorstudents SET status = 'Approved' WHERe idnumber = '$id'");
$to =$_GET['email'];
