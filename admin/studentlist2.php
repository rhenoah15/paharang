...
<!-- <a href="addstud2.php?grade=<?php echo $_GET['grade'] ?>&strand=<?php echo $_GET['strand'] ?>" class="btn" rel="facebox" style="float:right;width:200px">Enroll Student</a> -->
<br>
				...
				while($row = mysql_fetch_array($result))
					{
						...
						echo '<td width="25%"><div align="center"><a rel="facebox" href="viewsubject2.php?id='.$row['idnumber'].'">View Grades</a>   
						</a>   
						</div></td>';
						echo '</tr>';
					}
