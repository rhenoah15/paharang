  ...
  <div class="body-wrapper">
    ...
    <aside class="mdc-drawer mdc-drawer--dismissible mdc-drawer--open" style="background:#343a40">
      ...
      <div class="mdc-drawer__content">
        <div class="user-info">
         <center><p style="text-align:center" class="name">Administrator Account</p></center>
          ...
          <nav class="mdc-list mdc-drawer-menu">
            ...
            <div class="mdc-list-item mdc-drawer-item">
              <a class="mdc-expansion-panel-link" href="#" data-toggle="expansionPanel" data-target="ui-sub-menuc">
               <i class="fa-duotone fa-universal-access"></i>  &nbsp; Account Approval
                <i class="mdc-drawer-arrow material-icons">chevron_right</i>
              </a>
              <div class="mdc-expansion-panel" id="ui-sub-menuc">
                <nav class="mdc-list mdc-drawer-submenu">
                  <div class="mdc-list-item mdc-drawer-item">
                    <a class="mdc-drawer-link" href="app_j.php?id=Junior High School">
                      Junior High School
                    </a>
                  </div>
                  <div class="mdc-list-item mdc-drawer-item">
                    <a class="mdc-drawer-link" href="app_s.php?id=Senior High School">
                      Senior High School
                    </a>
                  </div>
