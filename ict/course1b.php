...
<input type="text" name="strand" required  style="width:100%;" class="form" >
							...
							<input type="submit" value="Add Grade" name="submit" class="btn" style="width:200px">
	...
	$id = $_GET['id'];
		...
		while($row1 = mysql_fetch_array($result1))
			...
			echo'	<td><center><a href="studentlist2.php?grade='.$row1['grade'].'&strand='.$row1['strand'].'" >Student List</a> <hr style="margin:0px"> <a href="subject2a.php?grade='.$row1['grade'].'&strand='.$row1['strand'].'" >Subject List</a></td>';
			echo'</tr>';
			}
