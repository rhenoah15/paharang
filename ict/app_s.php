				...
				while($row = mysql_fetch_array($result))
					{
						...
						echo '<td width="25%"><div align="center"><a  href="approve_student1.php?id='.$row['idnumber'].'&email='.$row['email'].'">Approve</a> 
						| <a href="decline_student1.php?id='.$row['idnumber'].'" id="'.$row['idnumber'].'" class="delbutton" title="Click To Drop">Decline</a></a>   
						</div></td>';
						echo '</tr>';
					}
				?> 
