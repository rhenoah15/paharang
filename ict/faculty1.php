				...
				while($row = mysql_fetch_array($result))
					{
						...
						echo '<td  valign="top"><div align="center"> <a href="grades.php?id='.$row['idnumber'].'" rel="facebox">Submitted Grades</a> <hr style="margin:0px" >  <a href="s1.php?id='.$row['idnumber'].'" >Class Scheduling</a> <hr style="margin:0px">  <a  href="viewworkload.php?id='.$row['idnumber'].'">View Load</a> <hr style="margin:0px"> <a href="del_faculty.php?id='.$row1['id'].'" onclick="return confirm(\'Are you sure you want to archive this record?\')">Archive Faculty</a></div></td>';
						echo '</tr>';
					}
					}
				?> 
