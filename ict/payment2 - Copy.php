...
include('../connect.php');
  ...
  $reason = $_POST['reason']; 
  $amount= $_POST['amount']; 
  $save1=mysql_query("INSERT INTO senior_payment (username, reason,amount) VALUES ('$username','$reason','$amount')");
  $message = "<span style='color:red'>Payment has been successfully recorded</span><br>";
}    
?>		<h3>Transaction - Senior High School</h3>
	...
	<?php
	include('../connect.php');
		$result1 = mysql_query("SELECT * FROM transaction WHERE year = 'Senior High School' ORDER BY ID DESC");
