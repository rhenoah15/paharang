...
?>
	...
	$id = $_GET['id'];
		...
		while($row1 = mysql_fetch_array($result1))
			...
			echo'	<td><center><a href="studentlist2.php?grade='.$row1['grade'].'&strand='.$row1['strand'].'" ><i class="fa-sharp fa-regular fa-graduation-cap"></i></a>  <a href="subject2a.php?grade='.$row1['grade'].'&strand='.$row1['strand'].'" ><i class="fa-sharp fa-regular fa-list"></i></a></td>';
			echo'</tr>';
			}
