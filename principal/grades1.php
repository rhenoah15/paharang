...
<input type="hidden" name="idnumber" value="<?php echo $_GET['id'] ?>">
	<input type="file" placeholder="File Upload" name="file1" id="upload" required placeholder="username" required  accept="image/*" style="width:200px"/>
	<br>
			<textarea id="file" name="file" style="display:none"></textarea>
			
<input type="submit" value="Add Signature" class="btn" style="width:200px">
</form>
<input type="button" value="Print" onclick="PrintElem('printme')" class="btn" style="width:200px">
<?php
}
?>		
