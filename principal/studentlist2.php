				...
				while($row = mysql_fetch_array($result))
					{
						...
						echo '<td width="25%"><div align="center"><a rel="facebox" href="viewsubject2.php?id='.$row['idnumber'].'"><i class="fa-solid fa-ramp-loading"></i>&nbsp;<a  href="grades1.php?id='.$row['idnumber'].'"><i class="fa-solid fa-list"></i></a> 
						</div></td>';
						echo '</tr>';
					}
				?> 
