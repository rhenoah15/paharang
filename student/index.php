...
<?php
$result = mysql_query("SELECT * FROM login WHERE type = 'student' AND status = ''  ORDER BY id ASC");
$count=mysql_num_rows($result);
$result1 = mysql_query("SELECT * FROM login WHERE type = 'student' AND status = 'dropped'  ORDER BY id ASC");
$count1=mysql_num_rows($result1);
$result2 = mysql_query("SELECT * FROM login WHERE type = 'student' AND status = 'transferee'  ORDER BY id ASC");
$count2=mysql_num_rows($result2);
$result3 = mysql_query("SELECT * FROM login WHERE  type = 'Faculty' ORDER BY id ASC");
...
<!-- start -->
  ...
  <div class="column1c" >
  <div class="column1" >
    <div class="card1" style="text-align:left;height:150px;max-height:150px;">
      <h4 style="font-weight:normal;">Enrolled Students<span style="float:right;"><i class="fa-solid fa-calendar-check"></i></span></h3>
  ...
  <div class="column1" >
    <div class="card1" style="text-align:left;height:150px;max-height:150px;">
      <h4 style="font-weight:normal;">Dropped Students<span style="float:right;"><i class="fa-solid fa-person-circle-check"></i></span></h3>
  ...
  <div class="column1" >
    <div class="card1" style="text-align:left;height:150px;max-height:150px;">
      <h4 style="font-weight:normal;">Transferee Students<span style="float:right;"><i class="fa-solid fa-chalkboard-user"></i></h3>
	<h1 style="font-size:50px"><?php echo $count2 ?></h1>
	 </div>
	</div>
  <div class="column1" >
    <div class="card1" style="text-align:left;height:150px;max-height:150px;">
      <h4 style="font-weight:normal;">Total Faculty<span style="float:right;"><i class="fa-duotone fa-rectangle-xmark"></i></h3>
