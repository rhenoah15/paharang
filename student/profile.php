...
$result1 = mysql_query("SELECT * FROM seniorstudents WHERE idnumber='$username'");
...
$result1a = mysql_query("SELECT * FROM teacher WHERE d1='$grade' AND d2 = '$strand'");
        ...
        <main class="content-wrapper">
          <div class="mdc-layout-grid">
			...
			if(isset($_POST['email'])) {
				...
				mysql_query("UPDATE login SET contact = '$contact' WHERE username = '$username'");
  ...
  .column1,.column2 {
    ...
    margin-bottom: 20px;
				 ...
				 if(isset($_POST['submit'])) {
					 $image = $_POST['file'];
					 mysql_query("UPDATE juniorstudents SET image= '$image' WHERE idnumber='$username'");
					 mysql_query("UPDATE seniorstudents SET image= '$image' WHERE idnumber='$username'");
				 }
				 ?>
				 <div class="row">
  <div class="column1" >
...
<input type="file" placeholder="File Upload" name="file1" id="upload" required placeholder="username" class="form-control"/>
  ...
  <div class="column2" style="text-align:left">
	...
	<form action="#" method="POST">
                      ...
                      <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-6-desktop">
                        <div class="mdc-text-field mdc-text-field--outlined">
                          <input class="mdc-text-field__input" id="text-field-hero-input" name="fname" value="<?php echo $name ?>" >
                          <div class="mdc-notched-outline">
                            <div class="mdc-notched-outline__leading"></div>
                            <div class="mdc-notched-outline__notch">
                      ...
                      <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-6-desktop">
                        <div class="mdc-text-field mdc-text-field--outlined">
                          <input class="mdc-text-field__input" id="text-field-hero-input" name="adviser" value="<?php echo $teacher ?>" >
                          <div class="mdc-notched-outline">
                            <div class="mdc-notched-outline__leading"></div>
                            <div class="mdc-notched-outline__notch">
                      ...
                      <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-6-desktop">
                        <div class="mdc-text-field mdc-text-field--outlined">
						<input class="mdc-text-field__input" id="text-field-hero-input" name="ext" value="<?php echo $gender ?>" >
                          <div class="mdc-notched-outline">
                            <div class="mdc-notched-outline__leading"></div>
                            <div class="mdc-notched-outline__notch">
					  ...
					  <br>
				  <br>
                     <input type="submit" name="submit" value="Update" class="mdc-button mdc-button--raised filled-button--success" style="width:150px">
					  </form>
