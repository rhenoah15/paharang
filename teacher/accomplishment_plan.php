...
if(isset($_POST['submit'])) {
  ...
  $save1=mysql_query("INSERT INTO accomplishment_plan (teacher, title,description) VALUES ('$idnumber','$title','$description')");
  echo '<script>alert("Accomplishment Plan has been added");window.location="accomplishment_plan.php"</script>';
}
?>
   <form class="form-horizontal" role="form" action="#" method="POST">
						<input type="hidden" name="teacher" value="<?php echo $idnumber ?>">
								...
								<table id="customers" class="table table-striped table-bordered table-hover" style="font-size:12px">
												<thead>
													<tr>
														<th><center>Accomplishment Plan</th>
											...
											include('../connect.php');
											$result = mysql_query("SELECT * FROM accomplishment_plan WHERE teacher = '$idnumber' order by id DESC");
											...
											echo'		<td><center><a href="view_accomplishment.php?id='.$row["id"].'" rel="facebox">View accomplishment Plan</a></td>';
											echo'	</tr>';
											}
											?>
