...
<h2>Lesson Plan</h2>
   <!--start-->
<button class="btn btn-primary" onclick="window.location='addlesson.php'" style="width:200px">Add Lesson Plan</button>
								<table id="customers" class="table table-striped table-bordered table-hover" style="font-size:12px">
												<thead>
													<tr>
														<th><center>Lesson Title</th>
											...
											include('../connect.php');
											$result = mysql_query("SELECT * FROM lesson WHERE teacher = '$idnumber' order by id DESC");
											...
											echo'		<td><center><a href="uplesson.php?id='.$row['id'].'">Update Lesson Plan</a> | <a href="viewlesson.php?id='.$row["id"].'">View Lesson</a></td>';
											echo'	</tr>';
											}
											?>
