...
@keyframes fade {
  ...
  to {opacity: 1}
	...
	<!-- start -->			
<h2>Advising Students- <?php echo $g1.' '.$g2 ?></h2>
   <!--start-->
...
<thead>
		...
		<?php
		$results = mysql_query("SELECT * FROM seniorstudents WHERE grade = '$g1' AND strand = '$g2'");
		...
		<form id="form1" method="post" action="savegrade.php" name="form1" onsubmit="return validateForm()">
			...
			<td style="border-left: 1px solid #C1DAD7" width="20%"><span style="float:left"><?php echo $rows['idnumber']?>
				...
				<td width=""><span style="float:left"><?php echo $rows['grade']?></td>
			
		<td width="10%"><span style="float:left"><a href="student_report.php?username=<?php echo $student ?>">Report on Learner's Observed Values</a></td>
