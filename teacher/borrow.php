...
<br>
				...
				<thead>
                                <tr>
                                    ...
                                    <th style="color:#FFF"><center>Date Returned</th>
...
date_default_timezone_set('Asia/Taipei');
				include('../connect.php');
		$result = mysql_query("SELECT * FROM borrow WHERE borrower = '$idnumber' AND status = 'Done'");
			...
			$returnd1 = $row['returnbook'];
				...
				while($row1 = mysql_fetch_array($result1))
					...
					$all =  floor($datediff/3600/24);
                                    ...
                                    echo '<td valign="top"><center>'.$returnd1.'</td>';
                                    echo '<td valign="top"><center>'.$status.'</td>';
									if($all  > 0 ) {
										// new
