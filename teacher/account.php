...
<h2>Account Settings</h2>
   <!--start-->
		...
		if($new_pass==$re_pass){
			$update_pwd=mysql_query("update user set password='$new_pass' where id='$id'");
	...
	<form method="post" style="padding-left:50px;">
				Old Password
					...
					<input type="password" name="old_pass" placeholder="Old Password" value="" required class="form"/>
			
				New Password
			
					<input type="password" name="new_pass" placeholder="New Password" value=""  required class="form" />
			
				Retype New Password
			
					<input type="password" name="re_pass" placeholder="Retype New Password" value="" required  class="form"/>
