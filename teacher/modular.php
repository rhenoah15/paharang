...
if(isset($_POST['submit'])) {
  ...
  $save1=mysql_query("INSERT INTO modular_plan (teacher, title,description) VALUES ('$idnumber','$title','$description')");
  echo '<script>alert("Modular Plan has been added");window.location="modular.php"</script>';
}
?>
   <form class="form-horizontal" role="form" action="#" method="POST">
						<input type="hidden" name="teacher" value="<?php echo $idnumber ?>">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Modular Plan </label>
								...
								<table id="customers" class="table table-striped table-bordered table-hover" style="font-size:12px">
											...
											include('../connect.php');
											$result = mysql_query("SELECT * FROM modular_plan WHERE teacher = '$idnumber' order by id DESC");
											...
											echo'		<td><center><a href="view_modular.php?id='.$row["id"].'" rel="facebox">View Modular Plan</a></td>';
											echo'	</tr>';
											}
											?>
