...
Seminar:
<input type="text" name="seminar" placeholder="Seminar" required class="form-control">
Date:
<input type="date" name="date" placeholder="Document/Seminar Name" required class="form-control">
Attached Certificate :
<input type="file" name="file" placeholder="Document Type" required class="form-control">
<input type="submit" name="Add Document" class="btn btn-primary" name="submit">
</form>
<br>
   <!--start-->
...
<tr>
	...
	$results = mysql_query("SELECT * FROM seminar WHERE idnumber = '$idnumber'");
	while($rows = mysql_fetch_array($results))
		{
		echo '<tr>'; 
		echo '<td>'.$rows['seminar'].'</td>';
