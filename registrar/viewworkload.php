...
<tr>
	...
	while($rows = mysql_fetch_array($results))
		...
		//	echo '<td>'.$timeinin.' - '.$timeoutin.'</td>';
			...
			echo '<td><a href="update_sched.php?id='.$rows['id'].'&idnumber='.$idnumber.'"><i class="fa-solid fa-pen-nib"></i></a> &nbsp;<a href="del_sched.php?id='.$rows['id'].'" onclick="return confirm(\'Are you sure you want to delete this record?\')"><i class="fa-solid fa-trash"></i></a></td>';
			echo '</tr>';
				}
