...
<br>
	...
	<div style="width:100%;overflow-x:scroll">
		<table id="customers" class="tftable order-table table bluetext">
			...
			<?php
				include('../connect.php');
				$result = mysql_query("SELECT * FROM seniorstudents WHERE grade = '$grade' AND strand = '$strand' AND status1 <> 'Drop'");
				while($row = mysql_fetch_array($result))
					{
						...
						echo '<td width="25%"><div align="center"><a  href="preview.php?id='.$row['idnumber'].'"><i class="fa-solid fa-list"></i></a></a> <a rel="facebox" href="viewsubject2.php?id='.$row['idnumber'].'"><i class="fa-solid fa-ramp-loading"></i></a>   <a href="drop2a.php?id='.$row['id'].'" id="'.$row['idnumber'].'" class="delbutton" title="Click To Drop" onclick="return confirm(\'Are you sure you want to drop this student?\')"><i class="fa-solid fa-box-archive"></i></a> 
						<a rel="facebox" href="changeyear2.php?id='.$row['idnumber'].'" ><i class="fa-regular fa-calendar-days"></i></a>   
						</div></td>';
						echo '</tr>';
					}
				?> 
