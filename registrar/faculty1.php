				...
				while($row = mysql_fetch_array($result))
					{
						...
						echo '<td  valign="top"><div align="center"> <a href="grades.php?id='.$row['idnumber'].'" rel="facebox"><i class="fa-solid fa-grate"></i></a> <a  href="viewworkload.php?id='.$row['idnumber'].'">';
						
						echo '<a href="viewsched.php?id='.$row['idnumber'].'" rel="facebox"><i class="fa-light fa-list"></i></a>  ';
						//echo '</a> <a href="s1.php?id='.$row['idnumber'].'" ><i class="fa-regular fa-calendar-days"></i></a> ''
